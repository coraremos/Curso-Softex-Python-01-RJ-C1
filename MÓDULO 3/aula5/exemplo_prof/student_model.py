...
class StudentModel:
    ...
    def create_student(self, nome, email):
        ...
        except sqlite3.IntegrityError: #erro de integridade do banco
    ...
    def find_student_by_id(self, student_id):
        ...
        student = self.db_conn.cursor.fetchone() #retorna um dicionário
        self.db_conn.close()
        return student
    ...
    def get_all_students(self):
        ...
        students = self.db_conn.cursor.fetchall() #retorna uma lista de dicionários/lista de informações
        self.db_conn.close()
        return students
